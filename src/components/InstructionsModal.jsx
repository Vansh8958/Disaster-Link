    ...
    <div style={{
      ...
      <div className="modal-content" style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', fontSize: '0.95rem', lineHeight: '1.6', color: '#cbd5e1' }}>
          <p style={{ margin: 0 }}>This is an AI-powered Emergency Command Center designed for low-connectivity disaster zones. Here is how to use the simulation:</p>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            ...
            <div><strong>Drone Recon (DRONE Button):</strong> Click "DRONE" in the left sidebar to overlay a simulated live picture-in-picture aerial video feed of the disaster zone.</div>
          </div>

          <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
            <MessageSquare size={20} color="#3b82f6" style={{ flexShrink: 0, marginTop: '4px' }} />
            <div><strong>Comms Terminal:</strong> Click "OPEN COMMS" at the bottom. Use "Global Mesh" to simulate an offline P2P chat. If you dispatch a team, use the "Mission" tab to chat directly with them via AI.</div>
          </div>
        </div>
