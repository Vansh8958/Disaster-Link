...
const MapComponent = ({ incidents, userLocation, selectedIncident, activeMission, droneScanActive, meshNetworkActive, heatmapActive, heatmapZones, onClaimIncident }) => {
    ...
    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }}>
      <MapContainer center={userLocation || defaultCenter} zoom={12} zoomControl={false} preferCanvas={true}>
        ...
        <LayersControl position="bottomright">
          ...
          <LayersControl.BaseLayer name="Dark Command Center">
            <TileLayer
          ...
          <LayersControl.BaseLayer checked name="Real Satellite & Labels (Google)">
            <TileLayer
