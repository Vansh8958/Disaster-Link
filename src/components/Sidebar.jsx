...
const Sidebar = ({ incidents, weatherData, filters, setFilters, onSOSClick, onSafeClick, onIncidentClick, droneScanActive, onToggleDrone, meshNetworkActive, onToggleMesh, heatmapActive, onToggleHeatmap, activeMission, onResolveMission, onOpenInstructions }) => {
