...
import { AlertCircle, Navigation, Users, Activity, CheckCircle, Radar, Cloud, Wind, Thermometer, Filter, ChevronLeft, ChevronRight, PhoneCall, Sun, Moon, CloudRain, CloudSnow, CloudLightning, CloudFog } from 'lucide-react';

const Sidebar = ({ incidents, weatherData, filters, setFilters, onSOSClick, onSafeClick, onIncidentClick, droneScanActive, onToggleDrone, meshNetworkActive, onToggleMesh, heatmapActive, onToggleHeatmap, activeMission, onResolveMission }) => {
    ...
    <>
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <Navigation color="var(--primary)" size={32} />
          <div>
            <h1 style={{ fontSize: '1.4rem', fontWeight: 800, letterSpacing: '-0.5px' }}>Disaster Link AI</h1>
            <p style={{ fontSize: '0.75rem', color: 'var(--success)' }}>● Triage Engine Active</p>
          </div>
        </div>
